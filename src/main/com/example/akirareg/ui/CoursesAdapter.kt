...
class CoursesAdapter(var courseList: List<CoursesResponse>):RecyclerView.Adapter<CoursesViewHolder>(){
    ...
    override fun onBindViewHolder(holder: CoursesViewHolder, position: Int) {
       var currentCourse=courseList.get(position)
        ...
        holder.tvDescription.text=currentCourse.courseId
        holder.tvInstructor.text=currentCourse.courseTrainer
    }
